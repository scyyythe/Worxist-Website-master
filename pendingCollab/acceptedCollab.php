...
$pendingExhibits = $exhibit->myAcceptedExhibits($u_id);
$pending = $exhibit->acceptedExhibits();
$response = [];
...
<div id="customAlert" class="alert-box">
    ...
    <div class="form">
        <div class="form-group">
            ...
            <div class="input-field">
                ...
                <input type="text" id="exhibit-title" name="exhibit-title" disabled placeholder="Enter the title of your exhibit" value="<?php echo htmlspecialchars($pending[0]['exbt_title']); ?>" required>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-field1">
                ...
                <textarea id="exhibit-description" disabled name="exhibit-description" placeholder="Describe the theme or story behind your exhibit" required><?php echo htmlspecialchars($pending[0]['exbt_descrip']); ?></textarea>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-field">
                ...
                <div class="date-picker">
                    <input type="date" id="exhibit-date" disabled name="exhibit-date" value="<?php echo htmlspecialchars($pending[0]['exbt_date']); ?>" required>
                </div>
            </div>
        </div>
    ...
    ?>            
            ...
            <div class="footer">
                <p>Please wait for your schedule.</p>
            </div>
        </div>
    </section>
